...
function rhs_svs_sub_menu()
    ...
    if cstm_head_dmg ~= 0 then
        chc_head_dmg_numW:SetValue(cstm_head_dmg)
    end

    if cstm_chest_dmg ~= 0 then
        chc_chest_dmg_numW:SetValue(cstm_chest_dmg)
    end
    
    if cstm_Larm_dmg ~= 0 then
        chc_Larm_dmg_numW:SetValue(cstm_Larm_dmg)
    end

    if cstm_Rarm_dmg ~= 0 then
        chc_Rarm_dmg_numW:SetValue(cstm_Rarm_dmg)
    end

    if cstm_Lleg_dmg ~= 0 then
        chc_Lleg_dmg_numW:SetValue(cstm_Lleg_dmg)
    end

    if cstm_Rleg_dmg ~= 0 then
        chc_Rleg_dmg_numW:SetValue(cstm_Rleg_dmg)
    end

    --[[if cstm_disarm_on ~= true then
        chc_disarm_numW:SetValue(cstm_disarm_on)
    end]]--
end